    ...
    <div className="border-2 border-black min-h-[450px] md:mx-20 lg:mx-30 mb-10">
      {boards.map((board) => (
        <>
          <h1
            key={board.boardId}
            className="bg-[#262626] text-white font-bold pl-7 py-5 text-xl"
          >
            {board.title}{" "}
          </h1>
          <ul>
            {board.tasks.map((task) =>
              !task.isCompleted ? (
                <>
                  <li
                    key={task.id}
                    className="flex-wrap md:justify-between pt-5 pb-5 px-10 text-center md:text-start md:flex md:px-8"
                  >
                    <div className="md:flex">
                      <svg
                        className="justify-center pt-1 md:pt-1 mx-auto md:m-0"
                        width="30"
                        height="30"
                      ...
                      >
                        <path
                          d="M139.61 35.5a12 12 0 0 0-17 0L58.93 98.81l-22.7-22.12a12 12 0 0 0-17 0L3.53 92.41a12 12 0 0 0 0 17l47.59
                      ...
                      <h4 className="font-bold text-xl md:pl-2 text-[#262626]">
                        {task.title}
                      </h4>
                      <p className="md:pl-3 text-lg text-center text-[#262626]">
                        {task.description}
                      </p>
                    </div>
                    <div className="flex justify-center pt-3 md:pt-0 md:justify-end ">
                      <svg
                        className={{ paddingTop: "6px", color: "#8B0000" }}
                        width="30"
                        height="30"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                      ...
                      >
                        <path
                          d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5
