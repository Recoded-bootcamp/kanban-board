  ...
  return (
    <section className="about container mx-auto flex flex-col justify-center items-center px-4 lg:px-0 py-8 max-w-5xl">
      <div className="flex flex-col gap-8 w-full min-h-[80vh] justify-center items-center">
        <div className="about-heaer text-center mb-8 flex flex-col gap-4 max-w-2xl">
        ...
        <div className="about-content flex flex-wrap justify-center gap-8">
          <div className="about-card flex flex-col items-center gap-2 bg-white rounded-lg shadow-lg w-full sm:w-fit	sm:px-8 py-4 dark:bg-neutral-800 hover:shadow-2xl transition">
            <img
              className="rounded-full w-32 h-32"
              src="https://github.com/Danah-94.png"
              alt="Danah Avatar"
            />
          ...
          <div className="about-card flex flex-col items-center gap-2 bg-white rounded-lg shadow-lg w-full sm:w-fit sm:px-8 py-4 dark:bg-neutral-800 hover:shadow-2xl transition">
            <img
              className="rounded-full w-32 h-32"
              src="https://github.com/Banel-Mikhael.png"
              alt="Helene Avatar"
            />
            <h3 className="text-xl font-bold mt-4">
            ...
            <ul className="">
              <li>
                <a href="https://github.com/Banel-Mikhael" className="">
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
          ...
          <div className="about-card flex flex-col items-center gap-2 bg-white rounded-lg shadow-lg w-full sm:w-fit sm:px-8 py-4 dark:bg-neutral-800 hover:shadow-2xl transition">
            <img
              className="rounded-full w-32 h-32"
              src="https://github.com/alandio.png"
              alt="Joseph Avatar"
            />
            <h3 className="text-xl font-bold mt-4">
              <a href="https://github.com/alandio">Aland Abdullah</a>
            </h3>
            <p className="text-center text-sm">Front-End Developer</p>
            <ul className=" ">
              <li>
